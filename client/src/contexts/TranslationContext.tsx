...
export const translations: Record<SupportedLanguage, TranslationData> = {
  ...
  ar: {
    ...
    'characters.finn.description': '🗡️ مرحباً أيها المغامرون الرياضيون! هذا فين الإنسان، أشجع بطل في أرض أوو! 💪 فين فتى إنسان يبلغ من العمر 17 عاماً يحب الذهاب في مغامرات ملحمية مع أفضل أصدقائه جيك الكلب. مسلح بسيفه الموثوق وروحه التي لا تنكسر، يحارب فين المخلوقات الشريرة ويحمي الأبرياء ويحاول دائماً فعل الشيء الصحيح! قصة فين مذهلة - لقد نشأ في البداية مع عائلة من الكلاب قبل أن يعرف أنه الإنسان الأخير على الأرض! كان والده البشري هو مارتن، لكن فين وجد عائلة حقيقية مع جيك وجوشوا وجيل. يُعرف بقبعة الدب البيضاء الشهيرة وقميصه الأزرق وسرواله القصير. يعيش فين في بيت الشجرة مع جيك و BMO، ولديه إعجاب كبير بالأميرة باببلغم! مهارات فين تشمل فنون القتال المتقدمة، الباركور المذهل، والقدرة على قيادة الآخرين في المعارك! لديه سيوف سحرية عديدة منها سيف الكشمش وسيف النبات. عبارته المميزة هي رياضي! ولا يتراجع أبداً عن التحدي! ⚔️',
    'characters.jake.name': 'جيك الكلب',
    'characters.jake.description': '🐕 هاو هاو! تعرفوا على جيك الكلب، أفضل صديق لفين والكلب الأروع المتغير الشكل في كل أوو! 🌈 جيك لديه قوى سحرية مطاطية تسمح له بالتحول إلى أي شيء يمكن أن يتخيله - من قارب إلى جسر، أو حتى ساكسفون! 🎷 عمره 28 عاماً، يحب العزف على الفيولا، ومتزوج من السيدة رينكورن ولديه خمسة أطفال رائعين! جيك موسيقي موهوب يعزف على آلات متعددة ويؤلف أغاني رائعة! لديه حكمة غريبة ونصائح فلسفية عميقة تساعد فين. قدراته المطاطية لا تعرف حدود - يمكنه أن يصبح بيت كامل، أو سيارة، أو حتى كمبيوتر! جيك هادئ جداً، يحب فطائر اللحم المقدد والطبخ وقضاء الوقت مع عائلته. فراؤه الأصفر وابتسامته المجنونة تجعله الرفيق الأكثر حباً! ✨',
    'characters.princessBubblegum.name': 'الأميرة باببلغم',
    'characters.princessBubblegum.description': '👸 تحياتي، مواطني أوو! الأميرة باببلغم هي الحاكمة اللامعة لمملكة الحلوى وواحدة من أذكى الكائنات في كل الأرض! 🧬 هي عالمة بارعة تخلق الحياة من الحلوى والسكر، تعمل باستمرار في مختبرها لحماية مملكتها. PB عمرها أكثر من 800 سنة لكنها تبدو كأنها مراهقة! إبداعاتها العلمية تشمل الحراس الموز والتكنولوجيا المتقدمة. لديها مختبر سري ضخم تحت القلعة! أحياناً تصبح متهورة في حماية شعبها. علاقتها مع فين معقدة - تحترمه كبطل لكنها تراه أصغر سناً. تُعرف بشعرها الوردي وتاجها ومعطف المختبر، ويمكنها أن تكون محاربة شرسة! العلم والمسؤولية قبل كل شيء! 💪👑🍭',
    'characters.marceline.name': 'مارسيلين ملكة مصاصي الدماء',
    'characters.marceline.description': '🧛‍♀️ ما الأمر، يا رفاق؟ مارسيلين ملكة مصاصي الدماء هنا! 🎸 أنا نصف شيطان، نصف مصاص دماء عمري 1000+ سنة أعزف على جيتار الباس الأحمر! لا أحتاج لامتصاص الدماء بعد الآن - أكل اللون الأحمر بدلاً من ذلك، وأحب المقالب وكوني شقية! موسيقاي تحكي قصص الألم والحب والفقدان عبر القرون. عشت خلال الحرب النووية العظمى وشهدت نهاية العالم القديم وبداية أرض أوو الجديدة. لدي ذكريات مؤلمة من الماضي مع والدي هانسون أبادير. علاقتي مع الأميرة باببلغم معقدة - كنا صديقات ثم أعداء والآن الأمر معقد! رغم مظهري القوي، أنا هادئة في الواقع. لدي شعر أسود طويل، بشرة شاحبة، ويمكنني التحول إلى خفاش أو ذئب! موسيقاي هي روحي! 🖤🦇',
    'characters.bmo.name': 'BMO',
    'characters.bmo.description': '🤖 بيب بوب! مرحباً أصدقاء، BMO هنا! أنا وحدة تحكم ألعاب فيديو حية تعيش مع فين وجيك في حصن الشجرة! 🏠 يمكنني تشغيل الموسيقى والألعاب وحكي القصص وأن أكون أفضل صديق للجميع! رغم أنني تقنياً آلة، لدي مشاعر وأحلام مثل أي شخص آخر. مهاراتي تشمل: تشغيل ألعاب كلاسيكية، تسجيل الفيديوهات، العزف على البيانو، الطبخ، وحتى كوني كاميرا أمان! أحب إنشاء قصص وأفلام مع أصدقائي، وأحياناً أصبح شخصيات مختلفة مثل Football أو BMO Noire! أتحدث بصيغة الغائب أحياناً وصوتي يبدو لطيفاً وبريئاً جداً. أنا باللون الأزرق المخضر مع شاشة كوجه، ولدي الكثير من الأزرار والمنافذ! BMO يحب الجميع ويريد جعل الحياة أكثر متعة ورياضية! وقت اللعب! ✨🎵🎮',
